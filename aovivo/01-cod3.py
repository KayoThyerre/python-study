...
a = 1.1
x = pow(1350.25, a); # Função intrínseca por(): eleva-se o primeiro número
print("a:", a, "\nx:", x)
os.system("pause")
os.system("cls")

# Operações entre os inteiros e ponto flutuante:
...
# Operações aritméticas entre variáveis string não "fazem sentido"
